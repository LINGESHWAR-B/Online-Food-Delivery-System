...
public class MainModule {
    ...
    private static void registerCustomer(){
        ...
        Customer customer = new Customer(1, name, email, phoneNumber, password);
        try{
    ...
    public static void createMenuItem(){
        ...
        MenuItem menuItem = new MenuItem(restaurantId, name, price, description, available);
    ...
    private static void placeOrder(){
        ...
        System.out.println("Enter restaurant ID to place order: ");
        int restaurantId = scanner.nextInt();
        ...
        for(MenuItem item : menuItems){
            ...
            System.out.println("Available Quantity: " + item.getAvailable());
            System.out.println();
        }
        ...
        if(selectedItem == null || selectedItem.getAvailable() < quantity){
    ...
    private static void viewOrders(){
        System.out.println("Enter customer ID to make payment: ");
        int customerId = scanner.nextInt();
